({
    helperMethodForProduct : function(component, event, helper) { 
        ...
        var userId = sURL.split('state=')[1];
        var baseURL = userId.substring(0, userId.indexOf("&"));
        console.log(baseURL);
    ...
    getCountryOptions: function(component, event,helper) {
        ...
        var baseURL = stateValue.substring(0, stateValue.indexOf("&"));
        console.log(baseURL);
        ...
        action.setCallback( this, function( response ) {
            ...
            if (state === "SUCCESS") {
                ...
                console.log('Size of  newItems = ' + fieldMap.length);
 ...
 //Progress indicator - start
    ...
    goRegistrationSummaryPage : function(component, event,helper,isCheckValidation) {
        console.log(isCheckValidation,'isCheckValidation');
        var count;
