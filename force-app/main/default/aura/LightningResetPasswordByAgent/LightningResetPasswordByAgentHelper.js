({
    doInit : function(component, event, helper) {
        helper.apexUtil(component,helper,'doResetPassword',{
        ...
        .then(function(result){
            ...
            if(result.Result === "Success"){
                ...
                helper.errorUtil(component,'Account','A new password for the following user has been sent via email','success');
