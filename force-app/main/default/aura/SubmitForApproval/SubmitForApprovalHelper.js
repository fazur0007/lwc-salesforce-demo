({
    doInit : function(component, event, helper) {
        helper.apexUtil(component,helper,'submitforWorkOrderApproval',{ recordId : component.get("v.recordId")})
        .then(function(result){
            window.caseconfig = result;
            console.log(JSON.stringify(caseconfig));
            if(result === "Success"){
                helper.errorUtil(component,'Work Order','Record sent for approval successfully !','success');
