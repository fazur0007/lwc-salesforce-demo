({
    doInit : function(component, event, helper) {
        helper.apexUtil(component,helper,'closeTask',{ recordId : component.get("v.recordId")})
        .then(function(result){
            window.objectConfig = result;
            console.log(JSON.stringify(objectConfig));
            if(result === "success"){
                helper.errorUtil(component,'Task','The Task has been closed Successfully','success');
                helper.navigationUtil(component,"view","Task",component.get("v.recordId"));
