({
    ...
    goRegistrationSummary : function(component, event,helper) {
        var isCheckValidation = true;
        helper.goRegistrationSummaryPage(component, event,helper,isCheckValidation);
        /*var count;
     ...
     getStageId :  function(component, event, helper) { 
        if (component.get('v.isThankYou')){
         ...
         if (current == 2){
          ...
          if (current == 3){
             var thirdMethodResult  = helper.goRegistrationSummaryPage(component, event,helper,false);
