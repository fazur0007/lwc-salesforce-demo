({
    doInit : function(component, event, helper) {
        helper.apexUtil(component,helper,'activateWorkOrder',{ recordId : component.get("v.recordId")})
        .then(function(result){
            window.caseconfig = result;
            console.log(JSON.stringify(caseconfig));
            if(result === "success"){
                helper.errorUtil(component,'Work Order','Work Order Activated','success');
