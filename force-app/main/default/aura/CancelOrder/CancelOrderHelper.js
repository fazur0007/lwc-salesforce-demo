    ...
    getCurrentRecordDetails : function(component, event, helper) {
        ...
        .then(function(result){
            ...
            if (orderDetails.Sent_to_AX) {
                helper.errorUtil(component,'Order Alert','Order cannot be cancelled, Order has already been sent to AX','warning');
            }else{
                helper.apexUtil(component,helper,'handleCancelOrder',{ recordId : orderDetails.Id})
                .then(function(result){
                    helper.errorUtil(component,'Order Success Alert','Order has been cancelled successfully','success');
